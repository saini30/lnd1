...
func TestPrepareAddOnion(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			targetIPAddress: "",
			cfg:             AddOnionConfig{VirtualPort: 9736},
			expectedCmd:     "ADD_ONION NEW:RSA1024 Port=9736,9736 ",
			expectedErr:     nil,
		},
		{
		...
		},
		{
			...
			expectedCmd: "ADD_ONION NEW:RSA1024 " +
				"Port=9736,127.0.0.1:18000 " +
				"Port=9736,127.0.0.1:18001 ",
			expectedErr: nil,
		},
		{
