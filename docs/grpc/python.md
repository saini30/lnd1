...
channel = grpc.secure_channel('localhost:10006', creds)
...
is at the default `localhost:10006`, with an open channel between the two nodes.
...
channel = grpc.secure_channel('localhost:10006', combined_creds)
stub = lnrpc.LightningStub(channel)
