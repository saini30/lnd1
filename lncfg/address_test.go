...
var (
	...
	addressTestVectors = []addressTest{
		{"tcp://127.0.0.1:9736", "tcp", "127.0.0.1:9736", true, false},
		{"tcp:127.0.0.1:9736", "tcp", "127.0.0.1:9736", true, false},
		{"127.0.0.1:9736", "tcp", "127.0.0.1:9736", true, false},
		{":9736", "tcp", ":9736", false, false},
		{"", "tcp", ":1234", false, false},
		{":", "tcp", ":1234", false, false},
		{"tcp4://127.0.0.1:9736", "tcp", "127.0.0.1:9736", true, false},
		{"tcp4:127.0.0.1:9736", "tcp", "127.0.0.1:9736", true, false},
		...
		{"tcp6:::1", "tcp", "[::1]:1234", true, false},
		{"localhost:9736", "tcp", "127.0.0.1:9736", true, false},
		...
		{
			"4acth47i6kxnvkewtm6q7ib2s3ufpo5sqbsnzjpbi7utijcltosqemad.onion:9736",
			"tcp",
			"4acth47i6kxnvkewtm6q7ib2s3ufpo5sqbsnzjpbi7utijcltosqemad.onion:9736",
			false,
			false,
